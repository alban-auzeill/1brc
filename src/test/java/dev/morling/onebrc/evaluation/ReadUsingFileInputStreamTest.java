...
import static dev.morling.onebrc.evaluation.ReadUsingFileInputStream.countByteInFileUsingThreadsWithBuffer;
...
class ReadUsingFileInputStreamTest {
  ...
  void count_bytes_in_a_13G_file_with_thread_and_buffer(int threadCount) throws IOException {
    assertEquals(13795277638L,
      time(() -> countByteInFileUsingThreadsWithBuffer(FILE_13G, threadCount),
